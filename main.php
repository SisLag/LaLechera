...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Sistema de Automatización Lechero y Agropecuario</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Inventario de Sislag">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=start" class="logo">
          <img style="margin-top:-10px" src="assets/img/finca.png" alt="Logo" height="60">
          <span style="font-size:20px">SISLAG</span>
        </a>
