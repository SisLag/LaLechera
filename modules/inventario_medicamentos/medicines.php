...
if(isset($_POST['dataidobat'])) {
  ...
  $query = mysqli_query($mysqli, "SELECT IdRegIcaMedicamento,NombreMedicamento,UnidadMedicamento,stock FROM registrosmedicamentos WHERE IdRegIcaMedicamento='$codigo'")
