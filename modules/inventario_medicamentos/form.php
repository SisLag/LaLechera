...
<script type="text/javascript">
  function tampil_obat(input){
    ...
    $.post("modules/inventario_medicamentos/medicines.php", {
      dataidobat: num,
    }, function(response) {      
      $('#stok').html(response)
...
if ($_GET['form'] == 'add') { ?> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?module=inventario_medicamentos"> Entrada </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/inventario_medicamentos/proses.php?act=insert" method="POST" name="formObatMasuk">
            <div class="box-body">
              <?php 

              $query_id = mysqli_query($mysqli, "SELECT RIGHT(codigo_inv,7) as codigo FROM inventario_medicamentos
              ...
              <div class="form-group">  
                ...
                <div class="col-sm-5">
                  <select class="chosen-select" name="codigo" data-placeholder="-- Seleccionar Medicamento --" onchange="tampil_obat(this)" autocomplete="off" required>
                    <option value=""></option>
                    <?php
                    $query_obat = mysqli_query($mysqli, "SELECT IdRegIcaMedicamento, NombreMedicamento FROM registrosmedicamentos ORDER BY NombreMedicamento ASC")
                      or die('error ' . mysqli_error($mysqli));
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a href="?module=inventario_medicamentos" class="btn btn-default btn-reset">Cancelar</a>
                </div>
              </div>
            </div><!-- /.box footer -->
          </form>
