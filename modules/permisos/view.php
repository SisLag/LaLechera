<section class="content-header">
  <h1>
    <i class="fa fa-folder-o icon-title"></i> Gestionar Permisos

    <a class="btn btn-success btn-social pull-right" href="?module=form_permisos&form=add" title="agregar" data-toggle="tooltip">
  ...
  <div class="row">
    ...
    ?>
      ...
      <div class="box box-success">
        <div class="box-body">
		<a class="btn btn-success glyphicon pull-left" href="?module=form_encargado&form=add" title="Agregar" data-toggle="tooltip">
