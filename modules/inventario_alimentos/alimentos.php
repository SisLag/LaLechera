...
if(isset($_POST['dataidobat'])) {
  ...
  $query = mysqli_query($mysqli, "SELECT RegIcaAlimento,NombreAlimento,UnidadAlimento,stock FROM registrosalimentos WHERE RegIcaAlimento='$codigo'")
