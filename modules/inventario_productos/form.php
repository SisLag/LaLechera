...
<script type="text/javascript">
  function tampil_obat(input){
    ...
    $.post("modules/inventario_productos/productos.php", {
      dataidobat: num,
    }, function(response) {      
      $('#stok').html(response)
...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?module=inventario_peoductos"> Entrada </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/inventario_productos/proses.php?act=insert" method="POST" name="formObatMasuk">
            <div class="box-body">
              <?php  
            
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(codigo_inv,7) as codigo FROM inventario_productos
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="codigo_inv" value="<?php echo $codigo_transaccion; ?>" readonly required>
                </div>
              </div>
              ...
              <div class="form-group">  
                ...
                <div class="col-sm-5">
                  <select class="chosen-select" name="codigo" data-placeholder="-- Seleccionar Producto --" onchange="tampil_obat(this)" autocomplete="off" required>
                    <option value=""></option>
                    <?php
                      $query_obat = mysqli_query($mysqli, "SELECT RegIcaProd, NombreProd FROM registrosproductos ORDER BY NombreProd ASC")
                                                            or die('error '.xml_error_string($mysqli));
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a href="?module=inventario_productos" class="btn btn-default btn-reset">Cancelar</a>
                </div>
              </div>
            </div><!-- /.box footer -->
          </form>
