...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT pt.IdPTernera,pt.FechPTernera,pt.AnimPTernera,pt.PesoPTernera,pt.AlzadaPTernera,pt.MedPTernera,pt.CantMedPTernera,rm.NombreMedicamento FROM pesajesterneras pt 
                                    INNER JOIN registrosmedicamentos rm ON pt.MedPTernera=rm.IdRegIcaMedicamento ORDER BY pt.IdPTernera DESC") 
