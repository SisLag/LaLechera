...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT IdTProducto, NombreTProducto FROM tiposproductos ORDER BY IdTProducto ASC") 
        ...
        <div id="isi">
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        <th height="20" align="center" valign="middle"><small>RegIcaProd</small></th>
                        <th height="20" align="center" valign="middle"><small>NombreProd</small></th>
                        <th height="20" align="center" valign="middle"><small>TipoProd</small></th>
                        <th height="20" align="center" valign="middle"><small>UnidadProd</small></th>
                        <th height="20" align="center" valign="middle"><small>NroLoteProd</small></th>
                        <th height="20" align="center" valign="middle"><small>stock</small></th>
						<th height="20" align="center" valign="middle"><small>EncargadoProd</small></th>
                        <th height="20" align="center" valign="middle"><small>DescProd</small></th>
                    </tr>
                </thead>
                <tbody>
<?php
