...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT IdSCalores,ModoInseminacion,ObservSCalores FROM servicioscalores 
                                    WHERE IdSCalores='$_GET[id]'
                                    ORDER BY IdSCalores ASC") 
        ...
        <div id="isi">
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        <th height="20" align="center" valign="middle"><small>IdSCalores</small></th>
                        <th height="20" align="center" valign="middle"><small>VacaSCalores</small></th>
                        <th height="20" align="center" valign="middle"><small>FechSCalores</small></th>
                        <th height="20" align="center" valign="middle"><small>ToroSCalores</small></th>
                        <th height="20" align="center" valign="middle"><small>ModoInseminacion</small></th>
                        <th height="20" align="center" valign="middle"><small>NroSCalores</small></th>
						<th height="20" align="center" valign="middle"><small>InseminSCalores</small></th>
                        <th height="20" align="center" valign="middle"><small>ObservSCalores</small></th>
                    </tr>
                </thead>
                <tbody>
<?php
