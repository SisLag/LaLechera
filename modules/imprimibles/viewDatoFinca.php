...
<section class="content-header">
  <h1>
    <i class="fa fa-file-text-o icon-title"></i>Informe de Registro - Datos Finca
  </h1>
  <ol class="breadcrumb">
    <li><a href="?module=start"><i class="fa fa-home"></i> Inicio</a></li>
    <li class="active">informe</li>
    <li class="active"> registro de datos finca</li>
  </ol>
</section>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-success">
        <!-- form start -->
        <form role="form" class="form-horizontal" method="GET" action="modules/imprimibles/printDatoFinca.php" target="_blank">
          <div class="box-body2">
