...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT NroPotreroHV,LoteHV,AreaHV,FechSalidaGanadoHV,FechAbonoHV,ProdAbonoHV,CantAbonoHV,TiempoCarenAbonoHV FROM hojasVida 
                                    WHERE NroPotreroHV='$_GET[id]'
                                    ORDER BY NroPotreroHV ASC") 
        ...
        <div id="isi">
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        <th height="20" align="center" valign="middle"><small>NroPotreroHV</small></th>
                        <th height="20" align="center" valign="middle"><small>LoteHV</small></th>
                        <th height="20" align="center" valign="middle"><small>AreaHV</small></th>
                        <th height="20" align="center" valign="middle"><small>FechEntradaGanadoHV </small></th>
                        <th height="20" align="center" valign="middle"><small>FechSalidaGanadoHV</small></th>
                        <th height="20" align="center" valign="middle"><small>NroAnimHV</small></th>
						<th height="20" align="center" valign="middle"><small>DiasOcupPotreroHV</small></th>
                        <th height="20" align="center" valign="middle"><small>DiasDesocupPotreroHV</small></th>
                        <th height="20" align="center" valign="middle"><small>FechAbonoHV</small></th>
						<th height="20" align="center" valign="middle"><small>ProdAbonoHV</small></th>
                        <th height="20" align="center" valign="middle"><small>CantAbonoHV</small></th>
                        <th height="20" align="center" valign="middle"><small>TiempoCarenAbonoHV</small></th>
                    </tr>
                </thead>
                <tbody>
<?php
