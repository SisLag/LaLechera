...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT RegIcaAlimento,NombreAlimento,TipoAlimento,UnidadAlimento,stock,EncargadoAlimento FROM registrosalimentos 
                                    ORDER BY RegIcaAlimento DESC") 
